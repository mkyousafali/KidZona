<script lang="ts">
  ...
  function playInstructions() {
    ...
    const greetings = {
      en: `Hi ${profile?.name}! Welcome to KidZona. Choose a learning module to start your journey. You can choose from information technology, spelling, languages, math, science, animals, sounds, or artificial intelligence. Click on any module to begin learning!`,
      hi: `नमस्ते ${profile?.name}! किडजोना में आपका स्वागत है। सीखना शुरू करने के लिए एक शिक्षण मॉड्यूल चुनें। आप सूचना प्रौद्योगिकी, स्पेलिंग, भाषाएं, गणित, विज्ञान, जानवर, ध्वनियों या कृत्रिम बुद्धिमत्ता में से चुन सकते हैं।`,
      ml: `കിഡ്‌സോണയിലേക്ക് സ്വാഗതം ${profile?.name}! വിദ്യാഭ്യാസ മൊഡ്യൂളുകളിൽ ഒന്നെണ്ണം തിരഞ്ഞെടുത്ത് നിങ്ങളുടെ യാത്ര ആരംഭിക്കുക. നിങ്ങൾക്ക് വിവരണ സാങ്കേതികത, അക്ഷരവിനിയോഗം, ഭാഷകൾ, ഗണിതം, ശാസ്ത്രം, മൃഗങ്ങൾ, ശബ്ദങ്ങൾ അല്ലെങ്കിൽ കൃത്രിമ ബുദ്ധിമത്ത് തിരഞ്ഞെടുക്കാൻ കഴിയും.`,
      ar: `مرحبا ${profile?.name}! أهلا وسهلا بك في KidZona. اختر وحدة تعليمية لبدء رحلتك. يمكنك الاختيار من بين تكنولوجيا المعلومات والتهجئة واللغات والرياضيات والعلوم والحيوانات والأصوات أو الذكاء الاصطناعي.`
    };
